...
+function ($) {
    ...
    Layout.prototype.fix = function () {
        ...
        if ($('body').hasClass(ClassName.fixed)) {
            ...
            $(Selector.contentWrapper).css('max-height', windowHeight - footerHeight);
        } else {
            var postSetHeight;
            ...
            if (windowHeight >= sidebarHeight) {
                ...
                $(Selector.contentWrapper).css('max-height', sidebarHeight);
...
+function ($) {
    ...
    PushMenu.prototype.toggle = function () {
        ...
        if (!isOpen) {
            //alert("开"),添加class, add by morgan
            //$(".main-sidebar").addClass("main-sidebar-scroll");
            this.open();
            $.sidebarMenuScroll();
        } else {
            //alert("关")，移除class, add by morgan
            //$(".main-sidebar").removeClass("main-sidebar-scroll");
            this.close();
        }
    };
