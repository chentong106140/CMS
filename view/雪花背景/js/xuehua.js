...
(function (THREE) {
        ...
        THREE.Matrix4.makeInvert3x3 = function (a) {
            var b = a.m33, c = b.m, d = a.n33 * a.n22 - a.n32 * a.n23, f = -a.n33 * a.n21 + a.n31 * a.n23,
                e = a.n32 * a.n21 - a.n31 * a.n22, g = -a.n33 * a.n12 + a.n32 * a.n13,
                h = a.n33 * a.n11 - a.n31 * a.n13,
                m = -a.n32 * a.n11 + a.n31 * a.n12, l = a.n23 * a.n12 - a.n22 * a.n13,
        ...
        THREE.Quaternion.prototype = {
            constructor: THREE.Quaternion, set: function (a, b, c, d) {
                ...
                b || (b = a);
                var c = a.x, d = a.y, f = a.z, e = this.x, g = this.y, h = this.z, m = this.w,
                    l = m * c + g * f - h * d,
        ...
        THREE.PerspectiveCamera.prototype.updateProjectionMatrix = function () {
            if (this.fullWidth) {
                var a = this.fullWidth / this.fullHeight, b = Math.tan(this.fov * Math.PI / 360) * this.near, c = -b,
                    d = a * c,
        ...
        THREE.CanvasRenderer = function (a) {
            ...
            var e = this, g, h, m, l = new THREE.Projector, a = a || {},
                j = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"), i, n, o, p,
                k = j.getContext("2d"),
                s = new THREE.Color(0), K = 0, C = 1, Q = 0, O = null, w = null, F = null, z = null, D = null, u, r, E,
                N,
                ...
                la = [], fa = [], ga, ha, ea, aa, Ba, Ca, Da, Ea, Fa, Ga, ma = new THREE.Rectangle,
                ...
                function Aa(a, b, c, d, e, g, h, i, j, m, o, n, l) {
                    if (l.image.width != 0) {
                        ...
                        var p = l.offset.x / l.repeat.x, r = l.offset.y / l.repeat.y, s = l.image.width * l.repeat.x,
                            u = l.image.height * l.repeat.y, h = (h + p) * s, i = (i + r) * u, j = (j + p) * s,
                            m = (m + r) * u,
                            o = (o + p) * s, n = (n + r) * u;
                        c -= a;
                        d -= b;
...
$(function () {
    ...
    particleImage.src = "image/zhu.png";
    //particleImage.src = "image/xuehua.png";
    var snowNum = 500;
